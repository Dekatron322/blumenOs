...
const AllClearingCashiers: React.FC = () => {
          ...
          <div className="mx-auto w-full px-3 py-8  sm:px-4 lg:px-6 ">
            <div className="mb-4 flex w-full justify-between max-md:flex-col max-sm:my-4 ">
              <div>
                ...
                <p>Clearing Cashier onboarding, commissions, and performance tracking</p>
              </div>
              ...
              >
                ...
                {agents.length === 0 ? (
                  <motion.div
                    ...
                    transition={{ duration: 0.4 }}
                  >
                    <EmptySearchState title={searchText ? "No matching clearing cashiers found" : "No clearing cashiers available"} />
                  </motion.div>
                ) : (
                  <>
                    ...
                    >
                      <div className="text-sm text-gray-700">
                        ...
                        of {totalRecords} clearing cashiers
...
export default AllClearingCashiers
