...
import { createFileIntent, finalizeFile, processAdjustmentBillingBulkUpload } from "lib/redux/fileManagementSlice"
...
const FileManagementPage = () => {
  ...
  const {
    ...
    finalizeFileLoading,
    finalizeFileError,
    adjustmentBillingBulkUploadLoading,
    adjustmentBillingBulkUploadError,
  ...
  const handleUpload = useCallback(async () => {
    ...
    try {
      ...
      const adjustmentColumns = extractedColumns
      ...
      const intentRequest = {
        ...
        purpose: "adjustments-bulk-record",
        checksum,
        bulkInsertType: "adjustments",
        ...
        xhr.addEventListener("load", async () => {
          if (xhr.status >= 200 && xhr.status < 300) {
            ...
            try {
              ...
              // Step 4: Process adjustment bulk upload
              console.log("=== Processing Adjustment Bulk Upload ===")
              try {
                const bulkResult = await dispatch(processAdjustmentBillingBulkUpload({ fileId })).unwrap()
                ...
                console.log("=== Adjustment Bulk Upload Complete ===")
                console.log("Bulk upload data:", bulkResult.data)

                // Show bulk upload success notification
                notify("success", "Adjustment Processing Started!", {
                  description: `File ${selectedFile.name} has been queued for adjustment processing`,
                  duration: 6000,
                })
              } catch (bulkError) {
                console.error("Bulk upload failed:", bulkError)
                // Show error notification
                notify("error", "Adjustment Bulk Upload Failed", {
                  description:
                    bulkError instanceof Error ? bulkError.message : "Failed to process adjustment bulk upload",
                  duration: 5000,
                })
  ...
  const handleReset = useCallback(() => {
    ...
    dispatch({ type: "fileManagement/resetAdjustmentBillingBulkUploadState" })
  }, [dispatch])
  ...
  const downloadSampleFile = useCallback(() => {
    const sampleData = [
      ...
      "NERC123456789,2026-01,1500.00",
      "NERC123456790,2026-01,750.50",
      "NERC123456791,2026-01,2200.75",
      "NERC123456792,2026-01,5000.00",
      "NERC123456793,2026-01,1200.25",
    ].join("\n")
    ...
    link.setAttribute("download", "sample_adjustments_bulk.csv")
          ...
          <div className="mx-auto flex w-full flex-col px-3 py-4 2xl:container sm:px-4 md:px-6 md:py-4 2xl:px-16">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-xl font-bold text-gray-900 sm:text-2xl">Bulk Upload Adjustments</h1>
                    <p className="text-sm text-gray-600">Upload billing adjustments in bulk using CSV or Excel files</p>
                  </div>
                </div>

                <div className="hidden items-center gap-3 sm:flex">
                  <ButtonModule variant="outline" size="sm" onClick={() => router.push("/billing/adjustments")}>
            ...
            <div className="w-full">
              ...
              >
                  ...
                  <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                    <div>
                      ...
                      <p className="text-sm text-blue-600">
                        Download our adjustment CSV template with the required columns:
                        <br /> CustomerAccountNo, MonthYear, Amount
                      </p>
                    </div>
                ...
                {uploadProgress && uploadProgress.percentage === 100 && (
                  <div className="mb-6 rounded-lg border border-green-200 bg-green-50 p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <ButtonModule variant="primary" size="sm" onClick={() => router.push("/billing/adjustments")}>
                        Go to Adjustments Page
                      </ButtonModule>
                    </div>
                  </div>
                ...
                {/* Error Messages */}
                {(fileIntentError || uploadError || finalizeFileError || adjustmentBillingBulkUploadError) && (
