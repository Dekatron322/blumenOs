...
const UploadTypeCard = ({
  ...
  const primaryJobType = Number.isNaN(parsedJobType) ? null : parsedJobType
  const { latestJob, isLoading } = useLatestJob(primaryJobType, enabled)
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.99 }}
      onClick={() => {
        if (primaryJobType !== null) {
          onSelect(primaryJobType)
        }
      }}
...
const FileManagementPage = () => {
  ...
  const uploadTypeOptions: UploadTypeOption[] = [
    ...
    //   value: getJobTypeValue("Bill Generate Missing")!,
    ...
    // },
    {
      ...
      value: getJobTypeValue("Bill Adjustment")!,
    ...
    },
    {
      ...
      value: getJobTypeValue("Bill Finalize")!,
    ...
    //   value: getJobTypeValue("Bill Crucial Ops")!,
    ...
    {
      name: "Bill Recompute",
      value: getJobTypeValue("Bill Recompute")!,
    ...
    },
    {
      ...
      value: getJobTypeValue("Feeder Energy Cap Import")!,
    ...
    },
    {
      ...
      value: getJobTypeValue("Meter Reading Import")!,
    ...
    },
    {
      ...
      value: getJobTypeValue("Bill Debt Recovery No Energy")!,
  ...
  const { templateColumns, isLoading: columnsLoading } = useTemplateColumns(selectedUploadType)
