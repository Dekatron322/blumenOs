            ...
            <div className="mb-6">
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-xl font-bold text-gray-900 sm:text-2xl">Bulk Upload Billing</h1>
                    <p className="text-sm text-gray-600">Upload billing records in bulk using CSV or Excel files</p>
                  </div>
                </div>
                    ...
                    {uploadProgress && uploadProgress.percentage === 100 && (
                      <div className="mb-6 rounded-lg border border-green-200 bg-green-50 p-4">
                        <div className="flex items-center justify-between">
                          ...
                          <ButtonModule variant="primary" size="sm" onClick={() => router.push("/billing/bulk-upload")}>
                            Go to Bulk Upload Page
                          </ButtonModule>
                        </div>
                      </div>
