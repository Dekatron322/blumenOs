...
const getJobTypeLabel = (jobType: number) => {
  const uploadTypeOptions = [
    { name: "Adjustment Billing", value: 17, description: "", requiredColumns: [], sampleData: [] },
    { name: "Bill Crucial Ops", value: 19, description: "", requiredColumns: [], sampleData: [] },
    { name: "Billing Bulk Upload", value: 20, description: "", requiredColumns: [], sampleData: [] },
    { name: "Bill Manual Energy", value: 21, description: "", requiredColumns: [], sampleData: [] },
    { name: "Bill Recompute", value: 30, description: "", requiredColumns: [], sampleData: [] },
    { name: "Meter Reading", value: 3, description: "", requiredColumns: [], sampleData: [] },
    { name: "Meter Reading General", value: 2, description: "", requiredColumns: [], sampleData: [] },
    { name: "Feeder Energy Cap", value: 36, description: "", requiredColumns: [], sampleData: [] },
  ]
...
const FileManagementPage = () => {
  ...
  const uploadTypeOptions: UploadTypeOption[] = [
    ...
    {
      name: "Mark Bills for Printing",
      value: 20,
      description: "Mark specific bills as ready for printing and dispatch",
    ...
    },
    {
      name: "Bill Recompute",
      value: 30,
      description: "Recompute bills for specific accounts and billing periods",
      requiredColumns: ["CustomerAccountNo", "MonthYear", "UsePaymentsFromTransactions"],
      sampleData: [
        "CustomerAccountNo,MonthYear,UsePaymentsFromTransactions",
        "123456789,2026-01,true",
        "987654321,2026-01,false",
        "555666777,2026-02,true",
      ],
    },
    {
    ...
    {
      name: "Debt Recovery (No Energy Bill)",
      value: 36,
      description: "Process debt recovery for accounts without energy bills",
      requiredColumns: ["CustomerAccountNo"],
      sampleData: ["CustomerAccountNo", "123456789", "987654321", "555666777"],
    },
  ]
            ...
            <div className="mb-8">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="hidden items-center gap-3 sm:flex">
                  <ButtonModule variant="outline" size="sm" onClick={() => router.push("/billing/bulk-upload")}>
                    View Upload History
                  </ButtonModule>
