            ...
            <div className="mb-6">
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-xl font-bold text-gray-900 sm:text-2xl">Bulk Upload Meters</h1>
                    <p className="text-sm text-gray-600">Upload meter records in bulk using CSV or Excel files</p>
                  </div>
                </div>
                ...
                {!hasCompletedUploadTypeSelection && (
                  <div className="mb-6 rounded-lg border-2 border-dashed border-gray-300 bg-[#f9f9f9] p-6">
                    ...
                    <p className="mb-6 text-sm text-gray-600">
                      Choose the type of meter bulk upload you want to perform. This determines how the system will
                      process your file.
                    </p>
                    ...
                    <div className="mb-6 rounded-lg bg-blue-50 p-4">
                      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                        <div>
                          ...
                          <p className="text-sm text-blue-600">
                            Download our metering CSV template with the required columns for the selected upload type.
                          </p>
                        </div>
