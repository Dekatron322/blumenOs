...
const getJobTypeLabel = (jobType: number) => {
  const uploadTypeOptions = [
    { name: "Meter Bulk Reassign", value: 12, description: "", requiredColumns: [], sampleData: [] },
    { name: "Meter Bulk Upload", value: 28, description: "", requiredColumns: [], sampleData: [] },
    { name: "Meter Change Out", value: 29, description: "", requiredColumns: [], sampleData: [] },
    { name: "Meter Change Status", value: 32, description: "", requiredColumns: [], sampleData: [] },
    { name: "Meter Reading", value: 15, description: "", requiredColumns: [], sampleData: [] },
    { name: "Meter Reading General", value: 2, description: "", requiredColumns: [], sampleData: [] },
    { name: "Meter Reading Stored Average Update", value: 16, description: "", requiredColumns: [], sampleData: [] },
  ]
...
const FileManagementPage = () => {
  ...
  const handleUploadTypeSelection = useCallback((uploadType: number | string) => {
    ...
    setSelectedUploadType(typeof uploadType === "number" ? uploadType : Number(uploadType))
    setExtractedColumns([])
            ...
            <div className="mb-8">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-4">
                  <div>
                    <h1 className="text-2xl font-bold text-gray-900 sm:text-2xl">Bulk Upload Meters</h1>
                  ...
                  <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
                    {uploadTypeOptions.map((type) => (
                      <UploadTypeCard
                        ...
                        onSelect={(uploadType) => {
                          handleUploadTypeSelection(uploadType)
                        }}
                      />
                    ))}
                  </div>
