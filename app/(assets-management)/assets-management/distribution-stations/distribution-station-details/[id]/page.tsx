...
import {
  ...
  fetchChangeRequestsByDistributionSubstationId,
  fetchDistributionSubstationById,
} from "lib/redux/distributionSubstationsSlice"
import jsPDF from "jspdf"
import autoTable from "jspdf-autotable"
import DistributionSubstationChangeRequestModal from "components/ui/Modal/distribution-substation-change-request-modal"
import type {
...
import ViewDistributionSubstationChangeRequestModal from "components/ui/Modal/view-distribution-substation-change-request-modal"
...
const DistributionSubstationChangeRequestsSection = ({
  ...
  const {
    ...
    changeRequestsByDistributionSubstationLoading,
    changeRequestsByDistributionSubstationError,
  ...
  // Fetch change requests for this distribution substation
  useEffect(() => {
    const params: ChangeRequestsRequestParams = {
      pageNumber: currentPage,
      pageSize: changeRequestsByDistributionSubstationPagination.pageSize,
    ...
    distributionSubstationId,
    currentPage,
    changeRequestsByDistributionSubstationPagination.pageSize,
    selectedStatus,
    selectedSource,
    searchText,
  ])
  ...
  useEffect(() => {
    return () => {
      dispatch(clearChangeRequestsByDistributionSubstation())
    }
  }, [dispatch])
  ...
  const totalPages = changeRequestsByDistributionSubstationPagination.totalPages || 1
  const totalRecords = changeRequestsByDistributionSubstationPagination.totalCount || 0
  ...
  if (changeRequestsByDistributionSubstationLoading) {
    return (
      <motion.div
      ...
      >
        <div className="mb-6 flex items-center justify-between">
          ...
          <button
            ...
            onClick={() => {
              /* TODO: Implement CSV export for distribution substation change requests */
            }}
            disabled={!changeRequestsByDistributionSubstation || changeRequestsByDistributionSubstation.length === 0}
          >
        ...
        {changeRequestsByDistributionSubstationError ? (
          <div className="py-8 text-center">
            ...
            <p className="text-gray-500">
              Error loading change requests: {changeRequestsByDistributionSubstationError}
            </p>
          </div>
        ) : changeRequestsByDistributionSubstation.length === 0 ? (
          <div className="py-8 text-center">
            <p className="text-gray-500">No change requests found for this distribution substation</p>
          </div>
        ) : viewMode === "grid" ? (
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            {changeRequestsByDistributionSubstation.map((changeRequest: ChangeRequestListItemType) => (
              <ChangeRequestCard
        ...
        {changeRequestsByDistributionSubstation.length > 0 && (
          <div className="mt-4 flex items-center justify-between">
            <div className="flex items-center gap-1">
              <p>Show rows</p>
              <select
                value={changeRequestsByDistributionSubstationPagination.pageSize}
...
const DistributionStationDetailsPage = () => {
  ...
  return (
    <section className="size-full">
            ...
            <div className="flex w-full px-16 py-8">
              <div className="flex w-full gap-6">
                ...
                <div className="flex w-full flex-col space-y-6 xl:col-span-2">
                  ...
                  <DistributionSubstationChangeRequestsSection
                    distributionSubstationId={currentDistributionSubstation.id}
                  />
                </div>
              </div>
            </div>
      ...
      <DistributionSubstationChangeRequestModal
        isOpen={activeModal === "changeRequest"}
        onRequestClose={closeAllModals}
        distributionSubstationId={currentDistributionSubstation.id}
        distributionSubstationName={currentDistributionSubstation.dssCode} // Use dssCode instead of name
