  ...
  const fetchTemplateColumns = useCallback(async () => {
    ...
    try {
      ...
      if (result.isSuccess && result.data) {
        const columns = extractColumnsFromCSV(result.data)
      ...
      if (error.message && error.message.includes(",")) {
        const columns = extractColumnsFromCSV(error.message)
        if (columns.length > 0) {
          setTemplateColumns(columns)
        } else {
...
const FileManagementPage = () => {
  ...
  const uploadTypeOptions: UploadTypeOption[] = [
    {
      name: "New Customers",
      value: getJobTypeValue("Customer Import")!,
    ...
    },
    {
      ...
      value: getJobTypeValue("Existing Customer Import")!,
    ...
    },
    {
      ...
      value: getJobTypeValue("Customer Info Update")!,
    ...
    },
    {
      ...
      value: getJobTypeValue("Customer Tariff Change")!,
    ...
    },
    {
      ...
      value: getJobTypeValue("Customer Status Change")!,
    ...
    },
    {
      ...
      value: getJobTypeValue("Customer Stored Average Update")!,
    ...
    },
    {
      ...
      value: getJobTypeValue("Customer SR/DT Update")!,
    ...
    },
    {
      ...
      value: getJobTypeValue("Postpaid Estimated Consumption Import")!,
