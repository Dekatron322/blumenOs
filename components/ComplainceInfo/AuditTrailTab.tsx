...
const AuditTrailTab: React.FC = () => {
  ...
  return (
    <motion.div className="relative" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.35 }}>
      ...
      <motion.div className="w-full overflow-x-auto border-x bg-[#FFFFFF] mt-4" initial={{ y: 8, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.35 }}>
          ...
          <thead>
            <tr>
              ...
              <th className="cursor-pointer whitespace-nowrap border-b p-4 text-sm" onClick={() => toggleSort("user")}>
                <div className="flex items-center gap-2">User <RxCaretSort /></div>
              </th>
              <th className="cursor-pointer whitespace-nowrap border-b p-4 text-sm" onClick={() => toggleSort("action")}>
                <div className="flex items-center gap-2">Action <RxCaretSort /></div>
              </th>
              <th className="cursor-pointer whitespace-nowrap border-b p-4 text-sm" onClick={() => toggleSort("module")}>
                <div className="flex items-center gap-2">Module <RxCaretSort /></div>
              </th>
              <th className="cursor-pointer whitespace-nowrap border-b p-4 text-sm" onClick={() => toggleSort("timestamp")}>
                <div className="flex items-center gap-2">Timestamp <RxCaretSort /></div>
              </th>
              <th className="cursor-pointer whitespace-nowrap border-b p-4 text-sm" onClick={() => toggleSort("ipAddress")}>
                <div className="flex items-center gap-2">IP Address <RxCaretSort /></div>
              </th>
          ...
          <tbody>
            <AnimatePresence>
              {pageItems.map((entry, idx) => (
                <motion.tr key={entry.auditId} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.25, delay: idx * 0.03 }} exit={{ opacity: 0, y: -8 }}>
                  ...
                  <td className="whitespace-nowrap border-b px-4 py-3 text-sm">
                    <span className="inline-flex items-center rounded-full px-3 py-1 text-sm font-medium bg-gray-50">{entry.module}</span>
                  </td>
                  ...
                  <td className="whitespace-nowrap border-b px-4 py-3 text-sm">
                    <motion.div style={getStatusStyle(entry.status)} className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-sm font-medium">
                      <span className="h-2 w-2 rounded-full" style={{ backgroundColor: entry.status === "approved" ? "#15803D" : entry.status === "flagged" ? "#B91C1C" : "#6B7280" }} />
      ...
      <motion.div className="flex items-center justify-between border-t py-3 mt-3" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
