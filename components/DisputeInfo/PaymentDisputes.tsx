          ...
          >
            <div className="py-1">
              <button
                ...
                className="block w-full px-3 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 sm:px-4"
              >
                View Details
              </button>
              <button
    ...
    <div className="mt-4 space-y-4">
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <button className="col-span-2 rounded-lg border border-gray-300 px-3 py-2 text-xs font-medium text-gray-700 hover:bg-gray-50">
            View Analytics
          </button>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-6 lg:flex-row">
          ...
          <div className="flex-1">
            <div className="rounded-lg border bg-white p-4 sm:p-6">
              <div className="mb-6">
                <h3 className="mb-2 text-lg font-semibold sm:text-xl">Recent Disputes</h3>
