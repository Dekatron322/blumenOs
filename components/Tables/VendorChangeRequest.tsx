...
import { ChangeRequestListItem, fetchVendorChangeRequests } from "lib/redux/vendorSlice"
...
const VendorChangeRequests = () => {
  ...
  // Fetch vendor change requests on component mount and when page changes
  useEffect(() => {
    dispatch(
      fetchVendorChangeRequests({
        ...
        ...(selectedEntityType && { publicId: selectedEntityType }),
      })
    )
  }, [
    dispatch,
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-2 flex flex-wrap items-center gap-4 text-sm text-gray-600">
                ...
                <span>
                  <strong>Public ID:</strong> {changeRequest.publicId.slice(0, 8)}...
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="w-full rounded-md border bg-white p-5">
          <div className="flex flex-col py-2">
            <div className="mb-4 flex items-center justify-between">
              <p className="text-2xl font-medium">Vendor Change Requests</p>
              <button
          ...
          <div className="w-full">
            {changeRequests.length === 0 ? (
              <div className="py-8 text-center">
                <p className="text-gray-500">No vendor change requests found</p>
              </div>
            ) : viewMode === "grid" ? (
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
