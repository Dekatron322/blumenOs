...
const AllPaymentChangeRequests = () => {
  ...
  return (
    <>
      <div className="flex-3 relative flex w-full flex-col-reverse items-start gap-6  2xl:mt-5 2xl:flex-row">
        {/* Main Content - Change Requests List/Grid */}
        <div className="w-full rounded-md border bg-white p-3 md:p-5">
          <div className="flex w-full flex-col py-2">
            <div className="mb-3 flex w-full items-center justify-between gap-3">
              <p className="whitespace-nowrap text-lg font-medium sm:text-xl md:text-2xl">Payment Change Requests</p>
