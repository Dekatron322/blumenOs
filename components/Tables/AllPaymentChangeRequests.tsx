...
import { ChangeRequestListItem, fetchChangeRequests } from "lib/redux/paymentSlice"
...
// This table mirrors the behaviour of AllCustomerChangeRequests/AllBillChangeRequest
// but is wired to the payments slice and payment change requests.
      ...
      <div className="mt-3 rounded-lg border bg-[#f9f9f9] p-4 shadow-sm transition-all hover:shadow-md">
        ...
        <div className="mt-3 flex gap-2">
          <button
            ...
            className="button-oulined flex flex-1 items-center justify-center gap-2 bg-white"
          >
        ...
        <div className="w-full rounded-md border bg-white p-5">
          <div className="flex flex-col py-2">
            <div className="mb-4 flex items-center justify-between">
              <p className="text-2xl font-medium">Payment Change Requests</p>
              <button
          ...
          <div className="w-full">
            {changeRequests.length === 0 ? (
              <div className="py-8 text-center">
                <p className="text-gray-500">No payment change requests found</p>
              </div>
            ) : viewMode === "grid" ? (
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
