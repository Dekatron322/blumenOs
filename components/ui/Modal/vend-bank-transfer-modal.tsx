...
const VendBankTransferModal: React.FC<VendBankTransferModalProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex shrink-0 items-center justify-between border-b bg-[#F9F9F9] px-6 py-4 max-sm:px-3 max-sm:py-3">
        ...
        <div className="flex shrink-0 gap-3 border-t bg-white px-6 py-4 max-sm:gap-2 max-sm:px-3 max-sm:py-3 sm:flex-row sm:gap-4">
