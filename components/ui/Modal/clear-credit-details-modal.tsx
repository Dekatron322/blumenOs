...
interface ClearCreditDetailsModalProps {
  isOpen: boolean
  onRequestClose: () => void
...
const ClearCreditDetailsModal: React.FC<ClearCreditDetailsModalProps> = ({
  isOpen,
  onRequestClose,
  selectedEvent,
  formatDateTime,
    ...
    >
      ...
      >
        <div className="flex w-full items-center justify-between bg-[#F9F9F9] p-4 md:p-6">
          <h2 className="text-lg font-bold text-gray-900 md:text-xl">Clear Credit Details</h2>
          <button
            onClick={onRequestClose}
...
export default ClearCreditDetailsModal
