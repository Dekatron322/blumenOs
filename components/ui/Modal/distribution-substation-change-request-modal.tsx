// components/DistributionSubstationChangeRequestModal.tsx
"use client"
...
import { submitChangeRequest } from "lib/redux/distributionSubstationsSlice"
...
interface DistributionSubstationChangeRequestModalProps {
  isOpen: boolean
  onRequestClose: () => void
...
const PATH_OPTIONS = [
  { value: "dssCode", label: "DSS Code" },
  { value: "nercCode", label: "NERC Code" },
  { value: "oldDssCode", label: "Old DSS Code" },
  { value: "transformerCapacityInKva", label: "Transformer Capacity (kVA)" },
  { value: "latitude", label: "Latitude" },
  { value: "longitude", label: "Longitude" },
  { value: "status", label: "Status" },
  { value: "numberOfUnit", label: "Number of Units" },
  { value: "unitOneCode", label: "Unit One Code" },
  { value: "unitTwoCode", label: "Unit Two Code" },
  { value: "unitThreeCode", label: "Unit Three Code" },
  { value: "unitFourCode", label: "Unit Four Code" },
  { value: "publicOrDedicated", label: "Public or Dedicated" },
  { value: "remarks", label: "Remarks" },
]

export const DistributionSubstationChangeRequestModal: React.FC<DistributionSubstationChangeRequestModalProps> = ({
  isOpen,
  onRequestClose,
  distributionSubstationId,
  distributionSubstationName,
  onSuccess,
}) => {
        ...
        <div className="max-h-[70vh] p-6">
          <div className="mb-6 text-center">
            <h3 className="mb-2 text-lg font-semibold text-gray-900">
              Request Changes for {distributionSubstationName}
            </h3>
            <p className="text-sm text-gray-600">
              Submit a change request for distribution substation details. Changes will require approval.
            </p>
          </div>
...
export default DistributionSubstationChangeRequestModal
