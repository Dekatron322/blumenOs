// components/PoleChangeRequestModal.tsx
"use client"
...
import { submitChangeRequest } from "lib/redux/polesSlice"
...
interface PoleChangeRequestModalProps {
  isOpen: boolean
  onRequestClose: () => void
  poleId: number
  poleName: string
...
const PATH_OPTIONS = [{ value: "htPoleNumber", label: "HT Pole Number" }]

export const PoleChangeRequestModal: React.FC<PoleChangeRequestModalProps> = ({
  isOpen,
  onRequestClose,
  poleId,
  poleName,
      ...
      >
        ...
        <div className="max-h-[70vh] p-6">
          <div className="mb-6 text-center">
            <h3 className="mb-2 text-lg font-semibold text-gray-900">Request Changes for {poleName}</h3>
            <p className="text-sm text-gray-600">
              Submit a change request for pole details. Changes will require approval.
            </p>
          </div>
...
export default PoleChangeRequestModal
