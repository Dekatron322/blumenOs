// components/InjectionSubstationChangeRequestModal.tsx
"use client"
...
import { submitChangeRequest } from "lib/redux/injectionSubstationSlice"
...
interface InjectionSubstationChangeRequestModalProps {
  isOpen: boolean
  onRequestClose: () => void
...
const PATH_OPTIONS = [
  ...
  { value: "injectionSubstationCode", label: "Injection Substation Code" },
  //   { value: "areaOfficeId", label: "Area Office" },
]

export const InjectionSubstationChangeRequestModal: React.FC<InjectionSubstationChangeRequestModalProps> = ({
  isOpen,
  onRequestClose,
  injectionSubstationId,
  injectionSubstationName,
  onSuccess,
}) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.error("Failed to submit change request:", error.message)
    } finally {
      setIsLoading(false)
    }
  }
      ...
      >
        ...
        <div className="max-h-[70vh] overflow-y-auto p-6">
          <div className="mb-6 text-center">
            <h3 className="mb-2 text-lg font-semibold text-gray-900">Request Changes for {injectionSubstationName}</h3>
            <p className="text-sm text-gray-600">
              Submit a change request for injection substation details. Changes will require approval.
            </p>
          </div>
