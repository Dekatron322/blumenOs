// components/FeederChangeRequestModal.tsx
"use client"
...
import { submitChangeRequest } from "lib/redux/feedersSlice"
...
interface FeederChangeRequestModalProps {
  isOpen: boolean
  onRequestClose: () => void
  feederId: number
  feederName: string
...
const PATH_OPTIONS = [
  { value: "name", label: "Feeder Name" },
  { value: "kaedcoFeederCode", label: "KAEDCO Feeder Code" },
  { value: "nercCode", label: "NERC Code" },
  { value: "feederVoltage", label: "Feeder Voltage" },
]

export const FeederChangeRequestModal: React.FC<FeederChangeRequestModalProps> = ({
  isOpen,
  onRequestClose,
  feederId,
  feederName,
      ...
      >
        ...
        <div className="max-h-[70vh] p-6">
          <div className="mb-6 text-center">
            <h3 className="mb-2 text-lg font-semibold text-gray-900">Request Changes for {feederName}</h3>
            <p className="text-sm text-gray-600">
              Submit a change request for feeder details. Changes will require approval.
            </p>
          </div>
...
export default FeederChangeRequestModal
