// components/AreaOfficeChangeRequestModal.tsx
"use client"
...
import { submitChangeRequest } from "lib/redux/areaOfficeSlice"
...
interface AreaOfficeChangeRequestModalProps {
  isOpen: boolean
  onRequestClose: () => void
  areaOfficeId: number
...
const PATH_OPTIONS = [
  { value: "nameOfNewOAreaffice", label: "New Area Office Name" },
  { value: "newKaedcoCode", label: "New KAEDCO Code" },
  { value: "newNercCode", label: "New NERC Code" },
  { value: "oldKaedcoCode", label: "Old KAEDCO Code" },
  { value: "oldNercCode", label: "Old NERC Code" },
  { value: "nameOfOldOAreaffice", label: "Old Area Office Name" },
  //   { value: "latitude", label: "Latitude" },
  //   { value: "longitude", label: "Longitude" },
]

export const AreaOfficeChangeRequestModal: React.FC<AreaOfficeChangeRequestModalProps> = ({
  isOpen,
  onRequestClose,
  areaOfficeId,
  areaOfficeName,
      ...
      >
        ...
        <div className="max-h-[70vh] p-6">
          <div className="mb-6 text-center">
            <h3 className="mb-2 text-lg font-semibold text-gray-900">Request Changes for {areaOfficeName}</h3>
            <p className="text-sm text-gray-600">
              Submit a change request for area office details. Changes will require approval.
            </p>
          </div>
...
export default AreaOfficeChangeRequestModal
