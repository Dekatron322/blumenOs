    ...
    const thermalReceiptContent = `
      ...
      <body>
        ...
        <div class="row">
          ...
          <span class="row-value">${vendData.reference || "N/A"}</span>
        </div>
        <div class="row">
        ...
        <div class="row">
          ...
          <span class="row-value">${vendData.customerName || "N/A"}</span>
        </div>
        <div class="row">
          <span class="row-label">Account:</span>
          <span class="row-value">${vendData.customerAccountNumber || "N/A"}</span>
        </div>
        ${
        ...
        <div class="row">
          ...
          <span class="row-value">${tokenData.meterNumber}</span>
        </div>
        `
            : ""
        }
        ...
        <div class="row">
          ...
          <span class="row-value">${vendData.channel || "N/A"}</span>
        </div>
        <div class="row">
        ...
        <div class="center">
          ...
          <div class="amount-large">${formatCurrency(vendData.totalAmountPaid || 0, vendData.currency || "NGN")}</div>
        </div>
        ...
        <div class="token-box">
          ...
          ${
            tokenData.meterNumber
              ? `<div style="font-size: 10px; margin-top: 4px;">Meter: ${tokenData.meterNumber}</div>`
              : ""
          }
        </div>
