...
const ClearCreditModal: React.FC<ClearCreditModalProps> = ({
  isOpen,
  onRequestClose,
  onConfirm,
  loading,
  ...
  return (
    ...
    >
      <div className="flex w-full items-center justify-between bg-[#F3F4F6] p-4">
        <h2 className="text-lg font-bold">Clear Credit</h2>
      ...
      <div className="px-4 pb-6">
        <div className="my-4 flex items-center gap-3">
          ...
          <div>
            <p className="font-medium text-gray-900">Confirm Credit Clear</p>
            <p className="text-sm text-gray-600">
              Are you sure you want to clear the credit for Meter ID: <strong>#{meterId}</strong>?
            </p>
          </div>
        </div>
        ...
        <div className="mb-4 rounded-md bg-amber-50 p-3">
          <p className="text-xs text-amber-800">
            <strong>Warning:</strong> This action will clear all credit on the meter and cannot be undone. Please ensure
            this action is authorized and necessary.
          </p>
        </div>
...
export default ClearCreditModal
