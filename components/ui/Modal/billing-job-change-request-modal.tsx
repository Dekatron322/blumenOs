// components/BillingJobChangeRequestModal.tsx
"use client"
...
import { submitChangeRequest } from "lib/redux/postpaidSlice"
...
interface BillingJobChangeRequestModalProps {
  isOpen: boolean
  onRequestClose: () => void
  billingJobId: number
  billingJobPeriod: string
...
const PATH_OPTIONS = [
  ...
  { value: "draftedCount", label: "Drafted Count" },
  { value: "finalizedCount", label: "Finalized Count" },
  { value: "skippedCount", label: "Skipped Count" },
  { value: "totalCustomers", label: "Total Customers" },
  { value: "processedCustomers", label: "Processed Customers" },
]

export const BillingJobChangeRequestModal: React.FC<BillingJobChangeRequestModalProps> = ({
  isOpen,
  onRequestClose,
  billingJobId,
  billingJobPeriod,
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between bg-[#F9F9F9] p-6">
          <h2 className="text-xl font-bold text-gray-900">Request Billing Job Changes</h2>
          <button
            onClick={handleClose}
        ...
        <div className="max-h-[70vh] p-6">
          <div className="mb-6 text-center">
            <h3 className="mb-2 text-lg font-semibold text-gray-900">Request Changes for Billing Job</h3>
            <p className="text-sm text-gray-600">
              Period: <span className="font-medium">{billingJobPeriod}</span> • Area Office:{" "}
              <span className="font-medium">{areaOfficeName}</span>
            </p>
            <p className="mt-2 text-sm text-gray-600">
              Submit a change request for billing job details. Changes will require approval.
            </p>
          </div>
...
export default BillingJobChangeRequestModal
