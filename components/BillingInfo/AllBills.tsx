  ...
  const transformApiBillsToTableBills = (): Bill[] => {
    ...
    return bills.map((apiBill) => {
      ...
      return {
        ...
        customerAddress: apiBill.customerAddress,
        customerPhoneNumber: apiBill.customerPhoneNumber,
        customerCity: apiBill.customerCity,
        customerState: apiBill.customerState,
