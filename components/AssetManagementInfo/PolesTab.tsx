        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="relative rounded-lg border bg-white p-4 shadow-sm">
              ...
              <div className="mb-2 size-32 overflow-hidden rounded bg-gray-200">
                <motion.div
                  className="h-full bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200"
                  animate={{
                    x: ["-100%", "100%"],
        ...
        >
          ...
          >
            ...
            <div className="w-full">
              <SearchModule
                prominent
                prominentTitle="Search Poles"
                prominentDescription="Find poles quickly by pole number, location, feeder, or operational status."
                value={searchInput}
