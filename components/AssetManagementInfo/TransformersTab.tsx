...
interface ActionDropdownProps {
  ...
  onViewDetails: (transformer: Transformer) => void
}

const ActionDropdown: React.FC<ActionDropdownProps> = ({ transformer, onViewDetails }) => {
          ...
          >
            <div className="py-1">
              ...
              <motion.button
                className="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100"
                onClick={() => {
                  console.log("Schedule maintenance for:", transformer.id)
                  setIsOpen(false)
                }}
                whileHover={{ backgroundColor: "#f3f4f6" }}
                transition={{ duration: 0.1 }}
              ...
              <motion.button
                className="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100"
                onClick={() => {
                  console.log("Update status for:", transformer.id)
                  setIsOpen(false)
                }}
                whileHover={{ backgroundColor: "#f3f4f6" }}
                transition={{ duration: 0.1 }}
...
const mockTransformers: Transformer[] = [
  {
    id: "TX-001",
    name: "Transformer 33/11KV Kaduna North",
  ...
  {
    id: "TX-002",
    name: "Transformer 33/11KV Barnawa",
    location: "Barnawa",
    capacity: "750 KVA",
    customers: 412,
    status: "operational",
  ...
  {
    id: "TX-003",
    name: "Transformer 11KV Ungwan Rimi",
  ...
  {
    id: "TX-004",
    name: "Transformer 33/11KV Sabon Tasha",
...
const TransformersTab: React.FC = () => {
  ...
  if (isError) return <div>Error loading transformer data</div>
                ...
                <AnimatePresence>
                  {transformers.map((transformer, index) => (
                    <motion.tr
                      ...
                      exit={{ opacity: 0, y: -10 }}
                    >
                      <td className="whitespace-nowrap border-b px-4 py-2 text-sm font-medium">{transformer.id}</td>
                      <td className="whitespace-nowrap border-b px-4 py-2 text-sm">{transformer.name}</td>
                      <td className="whitespace-nowrap border-b px-4 py-2 text-sm">{transformer.location}</td>
                      <td className="whitespace-nowrap border-b px-4 py-2 text-sm">{transformer.capacity}</td>
                      <td className="whitespace-nowrap border-b px-4 py-2 text-sm">{transformer.customers}</td>
                      <td className="whitespace-nowrap border-b px-4 py-2 text-sm">
                        <motion.div
                          style={getStatusStyle(transformer.status)}
                      ...
                      <td className="whitespace-nowrap border-b px-4 py-2 text-sm">{transformer.lastMaintenance}</td>
                      <td className="whitespace-nowrap border-b px-4 py-1 text-sm">
                        <ActionDropdown transformer={transformer} onViewDetails={setSelectedTransformer} />
                      </td>
                    </motion.tr>
                  ))}
                </AnimatePresence>
