          ...
          >
            <div className="py-1">
              ...
              <motion.button
                className="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100"
                onClick={() => {
                  console.log("Validate reading:", reading.meterId)
                  setIsOpen(false)
                }}
                whileHover={{ backgroundColor: "#f3f4f6" }}
                transition={{ duration: 0.1 }}
              ...
              <motion.button
                className="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100"
                onClick={() => {
                  console.log("Flag reading:", reading.meterId)
                  setIsOpen(false)
                }}
                whileHover={{ backgroundColor: "#f3f4f6" }}
                transition={{ duration: 0.1 }}
...
const mockMeterReadings: MeterReading[] = [
  {
    meterId: "MTR001234567",
    customer: "John Adebayo",
    dateTime: "2024-01-15 14:30",
    currentReading: "1850.5 kWh",
    previousReading: "1720.2 kWh",
    consumption: "130.3 kWh",
    status: "validated",
  },
  {
    meterId: "MTR001234568",
    customer: "Fatima Hassan",
    dateTime: "2024-01-15 15:45",
    currentReading: "2245.8 kWh",
    previousReading: "2120.5 kWh",
    consumption: "125.3 kWh",
    status: "validated",
  },
  {
    meterId: "MTR001234569",
    customer: "Chinedu Okafor",
    dateTime: "2024-01-14 09:15",
    currentReading: "1420.2 kWh",
    previousReading: "1420.2 kWh",
    consumption: "0 kWh",
    status: "flagged",
  },
]

const MeterReadingsTable: React.FC = () => {
  ...
  const getStatusStyle = (status: MeterReading["status"]) => {
    switch (status) {
      case "validated":
        return {
  ...
  if (isError) return <div>Error loading meter readings</div>
            ...
            <table className="w-full min-w-[800px] border-separate border-spacing-0 text-left">
              <thead>
                <tr>
                  ...
                  <th
                    className="cursor-pointer whitespace-nowrap border-b p-4 text-sm"
                    onClick={() => toggleSort("currentReading")}
                  >
                    <div className="flex items-center gap-2">
                      Current Reading <RxCaretSort />
                    </div>
                  </th>
                  <th
                    className="cursor-pointer whitespace-nowrap border-b p-4 text-sm"
                    onClick={() => toggleSort("previousReading")}
                  >
                    <div className="flex items-center gap-2">
                ...
                <AnimatePresence>
                  {readings.map((reading, index) => (
                    <motion.tr
                      ...
                      exit={{ opacity: 0, y: -10 }}
                    >
                      <td className="whitespace-nowrap border-b px-4 py-2 text-sm font-medium">{reading.meterId}</td>
                      <td className="whitespace-nowrap border-b px-4 py-2 text-sm">{reading.customer}</td>
                      <td className="whitespace-nowrap border-b px-4 py-2 text-sm">{reading.dateTime}</td>
                      <td className="whitespace-nowrap border-b px-4 py-2 text-sm">{reading.currentReading}</td>
                      <td className="whitespace-nowrap border-b px-4 py-2 text-sm">{reading.previousReading}</td>
                      <td className="whitespace-nowrap border-b px-4 py-2 text-sm">{reading.consumption}</td>
                      <td className="whitespace-nowrap border-b px-4 py-2 text-sm">
                        <motion.div
                          style={getStatusStyle(reading.status)}
