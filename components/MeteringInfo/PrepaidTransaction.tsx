                                    ...
                                    >
                                          ...
                                          <div>
                                            ...
                                            <div className="mt-2 space-y-2">
                                              ...
                                              <div className="flex justify-between text-sm">
                                                ...
                                                <span className="font-medium">{selectedTransaction.collectorType}</span>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div className="mt-6 flex justify-end gap-3">
                                        <ButtonModule
                                          size="sm"
                                          variant="outline"
                                          onClick={() => console.log("View receipt:", selectedTransaction.reference)}
                                        >
                                          View Receipt
                                        </ButtonModule>
                                        <ButtonModule
                                          size="sm"
                                          onClick={() => console.log("Download tokens:", selectedTransaction.reference)}
                                        >
                                          Download Tokens
                                        </ButtonModule>
                                      </div>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-3 md:p-5">
              <div className="space-y-4">
                ...
                {/* Prepaid Only Filter */}
                <div>
                  <label className="mb-1.5 block text-xs font-medium text-gray-700 md:text-sm">Transaction Type</label>
                  <div className="grid grid-cols-2 gap-2">
                    {[
