...
interface ActionDropdownProps {
  ...
  onViewDetails: (performance: PerformanceData) => void
}

const ActionDropdown: React.FC<ActionDropdownProps> = ({ performance, onViewDetails }) => {
          ...
          >
            <div className="py-1">
              ...
              <motion.button
                className="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100"
                onClick={() => {
                  console.log("Export performance:", performance.id)
                  setIsOpen(false)
                }}
                whileHover={{ backgroundColor: "#f3f4f6" }}
                transition={{ duration: 0.1 }}
              ...
              <motion.button
                className="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100"
                onClick={() => {
                  console.log("Analyze performance:", performance.id)
                  setIsOpen(false)
                }}
                whileHover={{ backgroundColor: "#f3f4f6" }}
                transition={{ duration: 0.1 }}
...
const mockPerformanceData: PerformanceData[] = [
  ...
  },
  {
    ...
    description: "Network reliability and outage frequency",
  },
  {
    id: "PERF-007",
    ...
    description: "Accuracy of customer billing statements",
  },
]
    ...
    <motion.div className="relative" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4 }}>
      ...
      >
        ...
        <div className="flex gap-4">
          <SearchInput placeholder="Search metrics..." value={searchText} onChange={handleSearch} className="w-80" />
      ...
      {filteredPerformanceData.length === 0 ? (
        ...
        >
          <EmptySearchState title={searchText ? "No matching performance data found" : "No performance data available"} />
        </motion.div>
      ) : (
        <>
          <motion.div
            ...
            <table className="w-full min-w-[1000px] border-separate border-spacing-0 text-left">
              <thead>
                <tr>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      Current Value <RxCaretSort />
                    </div>
                  </th>
                  <th
                    className="cursor-pointer whitespace-nowrap border-b p-4 text-sm"
                    onClick={() => toggleSort("targetValue")}
                  >
                    <div className="flex items-center gap-2">
                      Target Value <RxCaretSort />
                    </div>
                  </th>
                  <th
                    className="cursor-pointer whitespace-nowrap border-b p-4 text-sm"
                  ...
                  {filteredPerformanceData.map((data, index) => (
                    ...
                    >
                      ...
                      <td className="whitespace-nowrap border-b p-4">
                        ...
                        >
                          <span
                            ...
                            style={{
                              backgroundColor:
                                data.trend === "up" ? "#589E67" : data.trend === "down" ? "#AF4B4B" : "#6B7280",
                            }}
                          ></span>
                      ...
                      <td className="whitespace-nowrap border-b px-4 py-1 text-sm">
                        <ActionDropdown performance={data} onViewDetails={setSelectedPerformance} />
                      </td>
                    </motion.tr>
                  ))}
                </AnimatePresence>
