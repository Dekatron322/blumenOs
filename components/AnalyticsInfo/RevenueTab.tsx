...
interface ActionDropdownProps {
  revenue: RevenueData
  onViewDetails: (revenue: RevenueData) => void
}

const ActionDropdown: React.FC<ActionDropdownProps> = ({ revenue, onViewDetails }) => {
          ...
          >
            <div className="py-1">
              ...
              <motion.button
                className="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100"
                onClick={() => {
                  console.log("Export revenue:", revenue.id)
                  setIsOpen(false)
                }}
                whileHover={{ backgroundColor: "#f3f4f6" }}
                transition={{ duration: 0.1 }}
              ...
              <motion.button
                className="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100"
                onClick={() => {
                  console.log("Analyze revenue:", revenue.id)
                  setIsOpen(false)
                }}
                whileHover={{ backgroundColor: "#f3f4f6" }}
                transition={{ duration: 0.1 }}
...
const mockRevenueData: RevenueData[] = [
  ...
  },
  {
    ...
    prepaidRevenue: 17000000,
    postpaidRevenue: 11500000,
    collectionRate: 94.8,
  ...
  },
  {
    ...
    prepaidRevenue: 19500000,
    postpaidRevenue: 12500000,
    collectionRate: 97.8,
    outstandingAmount: 710000,
    customerCount: 1580,
    averageBill: 20253,
    growthRate: 12.3,
  },
    ...
    <motion.div className="relative" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4 }}>
      ...
      >
        ...
        <div className="flex gap-4">
          ...
          <button className="rounded-md bg-[#004B23] px-4 py-2 text-white hover:bg-[#000000]">Export Report</button>
        </div>
      </motion.div>
      ...
      {filteredRevenueData.length === 0 ? (
        ...
        >
          <EmptySearchState title={searchText ? "No matching revenue data found" : "No revenue data available"} />
        </motion.div>
      ) : (
        <>
          <motion.div
            ...
            <table className="w-full min-w-[1000px] border-separate border-spacing-0 text-left">
              <thead>
                <tr>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      Total Revenue <RxCaretSort />
                    </div>
                  </th>
                  <th
                    className="cursor-pointer whitespace-nowrap border-b p-4 text-sm"
                    onClick={() => toggleSort("prepaidRevenue")}
                  >
                    <div className="flex items-center gap-2">
                      Prepaid Revenue <RxCaretSort />
                    </div>
                  </th>
                  <th
                    className="cursor-pointer whitespace-nowrap border-b p-4 text-sm"
                    onClick={() => toggleSort("postpaidRevenue")}
                  >
                    <div className="flex items-center gap-2">
                      Postpaid Revenue <RxCaretSort />
                    </div>
                  </th>
                  <th
                    className="cursor-pointer whitespace-nowrap border-b p-4 text-sm"
                    onClick={() => toggleSort("collectionRate")}
                  >
                    <div className="flex items-center gap-2">
                      Collection Rate <RxCaretSort />
                    </div>
                  </th>
                  <th
                    className="cursor-pointer whitespace-nowrap border-b p-4 text-sm"
                  ...
                  {filteredRevenueData.map((data, index) => (
                    ...
                    >
                      ...
                      <td className="whitespace-nowrap border-b p-4">
                        ...
                        >
                          <span
                            className="size-2 rounded-full"
                            style={{
                              backgroundColor: data.growthRate > 0 ? "#589E67" : "#AF4B4B",
                            }}
                          ></span>
                          {data.growthRate > 0 ? "+" : ""}
                      ...
                      <td className="whitespace-nowrap border-b px-4 py-1 text-sm">
                        <ActionDropdown revenue={data} onViewDetails={setSelectedRevenue} />
                      </td>
                    </motion.tr>
                  ))}
                </AnimatePresence>
