...
const ClearTamperHistoryTab: React.FC<ClearTamperHistoryTabProps> = ({ meterId }) => {
      ...
      <div className="border-b bg-white p-4 transition-all hover:bg-gray-50">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-4">
            <div className="flex size-10 items-center justify-center rounded-full bg-red-100 max-sm:hidden">
              <Shield />
            </div>
  ...
  if (clearTamperHistoryError) {
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <p className="mt-1 text-sm text-gray-500">{clearTamperHistoryError}</p>
      </div>
    )
  }
    ...
    <div className="space-y-4">
      ...
      {paginatedData.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-12">
          ...
          <h3 className="mt-3 text-lg font-medium text-gray-900">No clear tamper events found</h3>
          <p className="mt-1 text-sm text-gray-500">No clear tamper events recorded for this meter</p>
        </div>
      ) : (
        <>
                    ...
                    <tr key={event.id} className="transition-colors hover:bg-gray-50">
                      <td className="px-3 py-2">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="text-xs font-medium text-gray-900">Clear Tamper #{event.id}</p>
                            {responseInfo.description && (
...
export default ClearTamperHistoryTab
