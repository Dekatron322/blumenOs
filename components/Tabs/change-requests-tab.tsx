    ...
    <div className="mt-3 rounded-lg border bg-[#f9f9f9] p-4 shadow-sm transition-all hover:shadow-md">
      ...
      <div className="mt-3 space-y-2 text-sm text-gray-600 md:mt-4">
        <div className="flex justify-between">
          <span className="text-xs md:text-sm">Reference:</span>
          <span className="text-xs font-medium md:text-sm">{changeRequest.reference}</span>
        </div>
        <div className="flex justify-between">
          <span className="text-xs md:text-sm">Requested By:</span>
          <span className="text-xs font-medium md:text-sm">{changeRequest.requestedBy}</span>
        </div>
        <div className="flex justify-between">
          <span className="text-xs md:text-sm">Entity Type:</span>
          <span className="text-xs font-medium md:text-sm">Customer</span>
        </div>
        <div className="flex justify-between">
          <span className="text-xs md:text-sm">Requested At:</span>
          <span className="text-xs font-medium md:text-sm">{formatDate(changeRequest.requestedAtUtc)}</span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-xs md:text-sm">Public ID:</span>
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between md:gap-0">
        <div className="flex items-start gap-3 md:items-center md:gap-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-2 hidden text-xs text-gray-500 md:block md:text-sm">Public ID: {changeRequest.publicId}</p>
          </div>
        </div>
          ...
          <div className="mt-2 flex flex-wrap gap-2 md:flex-nowrap md:gap-4">
            ...
            <div className="relative" data-dropdown-root="source-filter">
              ...
              >
                ...
                <ChevronDown
                  className={`size-3 text-gray-500 transition-transform md:size-4 ${isSourceOpen ? "rotate-180" : ""}`}
                />
              </button>
              {isSourceOpen && (
                <div className="absolute right-0 top-full z-50 mt-2 w-40 overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 md:w-48">
