...
const ClearCreditHistoryTab: React.FC<ClearCreditHistoryTabProps> = ({ meterId }) => {
  ...
  const handleClearCredit = async () => {
    await dispatch(clearCredit(meterId))
    if (!clearCreditError) {
  ...
  if (clearCreditHistoryError) {
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <p className="mt-1 text-sm text-gray-500">{clearCreditHistoryError}</p>
      </div>
    )
  }
    ...
    <div className="space-y-4">
      ...
      {paginatedData.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-12">
          ...
          <h3 className="mt-3 text-lg font-medium text-gray-900">No clear credit events found</h3>
          <p className="mt-1 text-sm text-gray-500">No clear credit events recorded for this meter</p>
        </div>
      ) : (
        <>
          {viewMode === "list" ? (
...
export default ClearCreditHistoryTab
