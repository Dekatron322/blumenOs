          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4">
              <div className="space-y-6">
                {/* Search Filter */}
                <div>
                  <label className="mb-2 block text-sm font-medium text-gray-700">Search Agent</label>
                  <input
                    type="text"
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={() => {
              setAppliedFilters({})
              setCurrentPage(1)
              dispatch(fetchAgents({ pageNumber: 1, pageSize, AgentType: "SalesRep" }))
            }}
  ...
  return (
    <div className="w-full space-y-5">
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-4">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-lg font-semibold text-gray-900">Sales Rep Directory</h2>
            <p className="mt-1 text-xs text-gray-600">Manage and monitor all sales representatives</p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button
                onClick={() => {
                  dispatch(fetchAgents({ pageNumber: currentPage, pageSize, AgentType: "SalesRep", ...appliedFilters }))
                }}
      ...
      <div className="rounded-xl border border-gray-200 bg-gradient-to-r from-green-50/60 to-white p-4 shadow-sm">
        <div className="mb-3">
          ...
          <h2 className="text-base font-semibold text-gray-900 sm:text-lg">Search Sales Representatives</h2>
          <p className="text-xs text-gray-600 sm:text-sm">
            Find sales representatives quickly by name, phone number, or agent ID.
          </p>
        </div>
        ...
        <SearchModule
          ...
          placeholder="Search by agent name, phone number, or agent ID..."
          height="h-14"
