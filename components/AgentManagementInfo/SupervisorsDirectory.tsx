          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4">
              <div className="space-y-6">
                {/* Search Filter */}
                <div>
                  <label className="mb-2 block text-sm font-medium text-gray-700">Search Supervisor</label>
                  <input
                    type="text"
  ...
  if (error) {
    return (
      <div className="rounded-lg border border-red-200 bg-red-50 p-4 shadow-sm">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-medium text-red-900">Error Loading Supervisors</h3>
          <button
            onClick={() => {
              setAppliedFilters({})
              setCurrentPage(1)
              dispatch(fetchAgents({ pageNumber: 1, pageSize, AgentType: "Supervisor" }))
            }}
  ...
  return (
    <div className="w-full space-y-5">
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-4">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-lg font-semibold text-gray-900">Supervisors Directory</h2>
            <p className="mt-1 text-xs text-gray-600">Manage and monitor all supervisors</p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button
                onClick={() => {
                  dispatch(
                    fetchAgents({ pageNumber: currentPage, pageSize, AgentType: "Supervisor", ...appliedFilters })
                  )
                }}
          ...
          <div className="overflow-hidden rounded-xl border border-gray-200 bg-white">
            {agents.length === 0 ? (
              <div className="flex h-72 flex-col items-center justify-center px-4">
                <EmptySearchState title="No supervisors found" description={searchText || getActiveFilterCount() > 0
