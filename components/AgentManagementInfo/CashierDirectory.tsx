          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4">
              <div className="space-y-6">
                {/* Search Filter */}
                <div>
                  <label className="mb-2 block text-sm font-medium text-gray-700">Search Cashier</label>
                  <input
                    type="text"
...
const CashierDirectory: React.FC = () => {
  ...
  if (error) {
    return (
      <div className="rounded-lg border border-red-200 bg-red-50 p-4 shadow-sm">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-medium text-red-900">Error Loading Cashiers</h3>
          <button
            onClick={() => {
              setAppliedFilters({})
              setCurrentPage(1)
              dispatch(fetchAgents({ pageNumber: 1, pageSize, AgentType: "Cashier" }))
            }}
  ...
  return (
    <div className="w-full space-y-5">
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-4">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-lg font-semibold text-gray-900">Cashier Directory</h2>
            <p className="mt-1 text-xs text-gray-600">Manage and monitor all cashiers</p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button
                onClick={() => {
                  dispatch(fetchAgents({ pageNumber: currentPage, pageSize, AgentType: "Cashier", ...appliedFilters }))
                }}
      ...
      <div className="rounded-xl border border-gray-200 bg-gradient-to-r from-green-50/60 to-white p-4 shadow-sm">
        <div className="mb-3">
          ...
          <h2 className="text-base font-semibold text-gray-900 sm:text-lg">Search Cashiers</h2>
          <p className="text-xs text-gray-600 sm:text-sm">
            Find cashiers quickly by name, phone number, or cashier ID.
          </p>
        </div>
        ...
        <SearchModule
          ...
          placeholder="Search by cashier name, phone number, or cashier ID..."
          height="h-14"
...
export default CashierDirectory
