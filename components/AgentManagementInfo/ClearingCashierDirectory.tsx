        ...
        >
          <div className="mb-4 sm:mb-6">
            <div className="mb-4 flex w-full flex-col justify-between gap-4 max-md:flex-col md:flex-row md:items-center">
              <h3 className="text-lg font-semibold sm:text-xl">Clearing Cashier Directory</h3>
            ...
            {error && (
              <div className="mt-2 rounded-lg bg-red-50 p-2 sm:p-3">
                <p className="text-xs text-red-600 sm:text-sm">Error loading clearing cashiers: {error}</p>
              </div>
            )}
          </div>

          {/* Clearing Cashiers List */}
          <div className="space-y-3 sm:space-y-4">
            {agents.map((agent) => {
                  ...
                  <div className="flex w-full flex-col items-start justify-between gap-3 sm:flex-row sm:items-center sm:gap-0">
                    ...
                    <div className="flex w-full items-center justify-between sm:w-auto sm:flex-col sm:items-end sm:justify-center sm:gap-1">
                      ...
                      <ButtonModule
                        ...
                        size="sm"
                        onClick={() =>
                          router.push(`/agent-management/all-clearing-cashiers/clearing-cashier-detail/${agent.id}`)
                        }
          ...
          {agents.length === 0 && !loading && (
            <div className="py-8 text-center">
              <p className="text-gray-500">No clearing cashiers found</p>
            </div>
          )}
        </motion.div>
      </div>
