...
export const API_ENDPOINTS = {
  ...
  FILE_MANAGEMENT: {
    ...
    CUSTOMER_BULK_UPLOAD: "/customers/bulk/import",
    CUSTOMER_SETUP_BULK_UPLOAD: "/customers/bulk/setup",
    CUSTOMER_INFO_UPDATE_BULK_UPLOAD: "/customers/bulk/info-update",
    CUSTOMER_FEEDER_UPDATE_BULK_UPLOAD: "/customers/bulk/feeder-update",
    CUSTOMER_TARIFF_CHANGE_BULK_UPLOAD: "/customers/bulk/tariff-change",
    CUSTOMER_STATUS_CHANGE_BULK_UPLOAD: "/customers/bulk/status-change",
    CUSTOMER_STORED_AVERAGE_UPDATE_BULK_UPLOAD: "/customers/bulk/stored-average",
    CUSTOMER_SRDT_UPDATE_BULK_UPLOAD: "/customers/bulk/srdt-update",
    METER_BULK_UPLOAD: "/meters/bulk/upload",
    METER_READING_BULK_UPLOAD: "/billing/postpaid/meter-readings/bulk",

    METER_READING_ACCOUNT_BULK_UPLOAD: "/billing/postpaid/meter-readings/bulk/account",
    METER_READING_STORED_AVERAGE_UPDATE_BULK_UPLOAD: "/billing/postpaid/meter-readings/bulk/stored-average",
    BILLING_BULK_UPLOAD: "/billing/postpaid/bulk-upload",
    MISSING_POSTPAID_BILLING_BULK_UPLOAD: "/billing/postpaid/bills/bulk/missing",
    PAST_POSTPAID_BILLING_BULK_UPLOAD: "/billing/postpaid/bills/bulk/past",
    ADJUSTMENT_BILLING_BULK_UPLOAD: "/billing/postpaid/bills/bulk/adjustments",
    FINALIZE_BILLING_BULK_UPLOAD: "/billing/postpaid/bills/bulk/finalize",
  ...
  POSTPAID_BILLING: {
    ...
    PUBLISH_BILLING_SCHEDULE_RUN: "/billing/schedules/runs/{runId}/publish",
    EXPORT_AR_SCHEDULE_RUN: "/billing/schedules/runs/{runId}/ar/export-job",
    RUN_PDF_GENERATION: "/billing/schedules/runs/{runId}/print/batch",
  ...
  VENDORS: {
    ...
    TOP_UP_SUMMARY: "/vendors/reports/topups/summary",
  },
