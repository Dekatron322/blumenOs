...
export const API_ENDPOINTS = {
  ...
  FILE_MANAGEMENT: {
    ...
    CSV_JOB_BY_ID: "/system/csv-jobs/{id}",
    ...
    CUSTOMER_MD_CATEGORY_UPDATE_BULK_UPLOAD: "/customers/bulk/md-category",
  ...
  POSTPAID_BILLING: {
    ...
    CANCEL_BILLING_SCHEDULE_RUN: "/billing/schedules/runs/{runId}/cancel",
    PUBLISH_BILLING_SCHEDULE_RUN: "/billing/schedules/runs/{runId}/publish",
    EXPORT_AR_SCHEDULE_RUN: "/billing/schedules/runs/{runId}/ar/export-jobs",
    ...
    TRACK_BILLING_SCHEDULE_CUSTOMERS_BULK: "/billing/schedules/runs/{runId}/customers/bulk/track",
